...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://rococo-taiyaki-3ba923.netlify.app/`
            : `https://rococo-taiyaki-3ba923.netlify.app/`, // Site domain. Do not include a trailing slash!
